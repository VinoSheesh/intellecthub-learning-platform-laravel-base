...
<header class="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-blue-600 to-blue-700 shadow-lg">
    <div class="flex items-center justify-between px-6 h-16">
        ...
        <div class="flex items-center space-x-4">
            <button id="sidebarToggle" class="text-white hover:bg-white/20 p-2 rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/25">
        ...
        <div class="hidden lg:flex items-center flex-1 max-w-md mx-8">
            <div class="relative w-full">
                ...
                <svg class="w-5 h-5 absolute left-4 top-4 text-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex items-center space-x-3">
            ...
            <!-- Notifications -->
            <div class="relative">
                <button class="text-white hover:bg-white/20 p-2 rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/25">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" class="flex items-center space-x-3 text-white hover:bg-white/20 px-4 py-2 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/25">
                    <div class="w-8 h-8 bg-gradient-to-br from-white/30 to-white/10 rounded-full flex items-center justify-center backdrop-blur-sm">
                ...
                <!-- Dropdown Menu -->
                <div x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" @click.outside="open = false" class="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 overflow-hidden">
