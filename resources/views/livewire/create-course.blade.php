<div class="w-full min-h-screen font-poppins bg-white p-6 pt-20 lg:p-8 text-slate-900">
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-600 text-lg font-medium">Buat kursus baru dan atur materi Anda</p>
    </div>

    <!-- Main Content Grid -->
    <form wire:submit.prevent="save" class="grid grid-cols-1 xl:grid-cols-3 gap-8 pb-12">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                <h2 class="text-xl font-bold text-slate-800 mb-5 flex items-center gap-2">
                    <i class="fa-solid fa-toggle-on text-slate-400"></i> Publikasi
                </h2>
                
                <div class="border bg-slate-50 border-slate-200 p-4 rounded-xl">
                    <div class="flex items-center justify-between">
                        <div>
                            <span class="font-bold text-slate-800 text-sm block mb-1">Status Kursus</span>
                            <span class="text-xs text-slate-500">
                                Disimpan sebagai Draft secara default
                            </span>
                        </div>
                        <div class="px-3 py-1 bg-slate-200 text-slate-600 text-xs font-bold rounded-full border border-slate-300 shadow-sm flex items-center gap-1.5 cursor-not-allowed" title="Pengaturan ini dikunci saat membuat kursus baru">
                            <i class="fa-solid fa-lock text-[10px]"></i> Draft
                        </div>
                    </div>
                    <div class="mt-4 text-[11px] text-slate-600 border-t border-slate-200 pt-3 flex gap-2">
                        <i class="fa-solid fa-circle-info text-blue-500 mt-0.5"></i>
                        <p>Kursus baru akan selalu ditetapkan sebagai <strong>Draft</strong>. Anda baru dapat mempublikasikannya melalui halaman <strong class="text-blue-600">Edit Kursus</strong> setelah menambahkan minimal 1 komponen materi (lesson).</p>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        // Listen untuk event courseCreated
        ...
        Livewire.on('swal:error', function(errorInfo) {
            // Karena errorInfo dikirim sebagai array, parameter pertama di dalam array adalah object data kita
