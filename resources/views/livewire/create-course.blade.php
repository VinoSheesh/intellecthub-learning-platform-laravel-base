    ...
    <div class="max-w-screen-lg p-6 rounded-3xl shadow">
        <form wire:submit.prevent="save" class="space-y-6">
            <div class="max-w-md">
                ...
                <input type="text" wire:model="title" class="w-full border border-gray-300 rounded-lg shadow-sm mt-2">
            </div>

            <div class="max-w-md">
                <label class="font-medium">Deskripsi</label>
                <textarea wire:model="description" class="w-full border border-gray-300 rounded-lg shadow-sm mt-2"></textarea>
            </div>
            ...
            <button type="submit" class="px-4 py-2 h-11 bg-blue-600 hover:bg-blue-700  text-white rounded-lg mt-4">Tambah
                Kursus</button>
        </form>
    </div>
