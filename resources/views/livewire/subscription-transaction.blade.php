<div class="min-h-screen bg-white px-2 sm:px-1 lg:px-8 font-poppins">
    <div class="max-w-md mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 pb-6">
                <div class="flex items-center justify-center gap-2 text-xs text-gray-600 bg-gray-50 py-3 px-1 rounded-lg border border-gray-200">
