<div class="w-full min-h-screen font-poppins bg-white p-6 lg:p-8">
    ...
    <div class="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-gray-200">
        <div class="w-20 h-20 bg-rose-50 rounded-full flex items-center justify-center mb-5">
            <i class="fas fa-heart text-rose-300 text-3xl"></i>
        </div>
        <h3 class="text-xl font-bold text-gray-800 mb-2">Belum Ada Kursus Favorit</h3>
        <p class="text-gray-500 text-center max-w-sm">Tandai kursus yang Anda senangi dengan menekan logo Hati pada kartu.</p>
    </div>
    @endif
</div>
